...
exports.saveSettings = async (req, res) => {
  ...
  ['registration_enabled', 'require_email_verification', 'require_admin_approval', 'news_demo_engagement_enabled', 'live_activity_show_code', 'twofa_email_recovery', 'otp_public_feed'].forEach(flag);
