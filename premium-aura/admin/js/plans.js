...
const fields = (p = {}) => [
  ...
  { name: 'resource_limit', label: 'Resource limit', type: 'number', value: p.resource_limit ?? '', placeholder: 'blank = unlimited' },
...
export async function mount(el) {
  const list = listPage(el, {
    ...
    columns: [
      ...
      { label: 'Limit', render: (p) => (p.resource_limit === null ? 'Unlimited' : num(p.resource_limit)) },
